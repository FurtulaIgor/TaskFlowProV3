/*
  ...
  1. Changes
    - Remove all existing problematic policies for user_roles
    - Create simple, non-recursive policies
    - Allow users to read their own roles
    - Create separate admin management approach

  2. Security
    - Users can only see their own roles
    - Admin operations will be handled through application logic
