...
-- Step 5: Create a new non-recursive admin check function
...
-- Step 7: Recreate all necessary policies using the new function
...
-- Step 8: Create the RPC function with the correct signature
