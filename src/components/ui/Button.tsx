...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-teal-600 text-white hover:bg-teal-700 focus:ring-4 focus:ring-teal-300',
    outline: 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-200',
