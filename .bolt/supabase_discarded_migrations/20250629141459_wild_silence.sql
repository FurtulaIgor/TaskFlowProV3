/*
  # Admin Status Check and Fix Migration

  1. Functions Created
    - `check_email_admin_status(email)` - Check if an email has admin role
    - `ensure_admin_role_for_email(email)` - Grant admin role to an email
    - `list_admin_users()` - List all users with admin role

  2. Purpose
    - Diagnose admin role issues
    - Provide easy way to grant admin role
    - Fix missing admin roles
*/
